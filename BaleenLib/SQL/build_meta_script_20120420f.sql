...
/****** Object:  StoredProcedure [dbo].[bproc_generate_meta]    Script Date: 04/20/2012 16:07:37 ******/
SET ANSI_NULLS ON
GO
...
ALTER procedure [dbo].[bproc_generate_meta]
...
CREATE TABLE [dbo].[BSET_LIST](
	...
	[VIEW_FIELD] bit default 0,
	[XTAB_FIELD] bit default 0,
	[CUBE_FIELD] bit default 0
) ON [PRIMARY];
...
cast(0 as bit) as VIEW_FIELD,
cast(0 as bit) as XTAB_FIELD,
cast(0 as bit) as CUBE_FIELD  
